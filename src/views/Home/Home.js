			...
			>
				...
				<div className='row about' id='about'>
					...
					>
						...
						India (In Virtual Mode). IConIC- 2022 aims to bring
						together Academicians, Researchers, Industry Experts,
						Enthusiasts, and Professionals to explore emerging
						trends and innovations, as well as discuss research
						findings and future directions in the area of
						next-generation innovations. This technical conference
						intends to provide an opportunity for academia and
						industry to share research and development advancements
						in emerging fields of Intelligent Computing. It offers a
						common platform to an interdisciplinary group of
						researchers through a strategically designed network of
						premier institutions across India. The conference has
						also Expert Panel discussions and Plenary Talks.
						<br />
						The goal of Application of Internaltional Conference on
						Intelligent Computing (IConIC) is to promote and bring
						together the Indian and global researchers across the
						areas of Artificial Intelligence, computer vision,
						computational biology, natural language processing, and
						deep learning.
						<br />
						<br />
				...
				<div className='row'>
					...
					>
						- All the accepted and presented papers will be
						published on <b>IEEE Digital Library</b> and it will be{' '}
						<b>Scopus Indexed</b>.
					</p>
				</div>
				<div
				...
				<div>
					<div id='reach-us' style={{ width: '100%' }}>
						<div
							...
							<div className='reach-us-info'>
								...
								<div className='reach-us-email'>
									...
									<p className='hh5' style={{}}>
										<h5>
											For any qeuery, feel free to mail
											us,{' '}
											<a
												id='mail'
												style={{
